  ...
  const handleConfirm = async () => {
    ...
    if (sendCode.data.success === true){
        ...
        if (sendPayment.data.success === true){
            const createOrder = await orderApi.createOrder(name, address, phone, transformArray(currentCart), total_price);
    ...
    <div className="flex flex-col items-center pb-[100px]">
      <div className="max-w-[1200px] w-[1200px] flex flex-col justify-center items-center">
        ...
        <div className="cart-section flex flex-col w-full gap-y-6">
            ...
            <div className="cart-item-section bg-white border rounded-md border-grey-300 flex flex-col divide-y"  style={{ padding: '16px' }}>
                <TextField
                    label="Name"
                    value={name}
        ...
        <Dialog open={openPin} onClose={handleCancel}>
            ...
            <DialogActions>
                ...
                <Button onClick={handleConfirm} color="primary" disabled={pin.length !== 6}>
                Confirm
                </Button>
            </DialogActions>
            </Dialog>
